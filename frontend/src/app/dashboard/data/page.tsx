...
type Tab = "import-export" | "audit" | "bridge";
...
const TABS: { id: Tab; label: string; icon: React.ComponentType<{ className?: string; style?: React.CSSProperties }> }[] = [
  ...
  { id: "bridge",        label: "Bridge",            icon: Database },
];
...
export default function DataPage() {
  ...
  const [bridgeDatabase, setBridgeDatabase] = useState("");
  ...
  async function handleBridgeDelete() {
    try {
      ...
      setBridgeHost(""); setBridgePort("3306"); setBridgeDatabase(""); setBridgeUser("");
