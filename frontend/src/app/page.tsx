    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-20 text-center">
        ...
        <p className="mb-8 max-w-lg text-sm text-muted-foreground">
          <span className="font-medium text-foreground">Server member?</span>{" "}
          Sign in with Discord to add or update your{" "}
          <abbr title="Steam64: 7656119… (17 digits)" className="cursor-help underline decoration-dotted underline-offset-2">
            Steam64
          </abbr>{" "}
          or{" "}
          <abbr title="EOS ID: 32 hex characters" className="cursor-help underline decoration-dotted underline-offset-2">
            EOS ID
          </abbr>{" "}
          on My Whitelist — same data as <code className="rounded bg-muted px-1 py-0.5 text-xs">/whitelist</code> in your server.
        </p>
        <div className="mb-12 w-full max-w-4xl overflow-hidden rounded-xl border border-white/[0.08] bg-muted/20 shadow-2xl">
          <img
            src="/hero-dashboard.png"
            alt="Squad Whitelister admin dashboard preview"
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <a href="/login">
            <Button
              size="lg"
              variant="outline"
              className="px-8 py-6 text-base border-white/[0.12]"
            >
              Member — My Whitelist
            </Button>
          </a>
