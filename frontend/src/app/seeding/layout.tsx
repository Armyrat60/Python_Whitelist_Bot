...
export default function SeedingLayout({
  children,
}: {
    ...
    <div className="flex min-h-screen flex-col bg-background">
      <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-white/[0.06] px-6 backdrop-blur-md"
        ...
        <div className="flex items-center gap-3">
          <h1 className="text-lg font-semibold">Seeding Leaderboard</h1>
          <GuildSwitcher />
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="hidden text-sm font-medium sm:inline-block">{session.username}</span>
          </div>
          <a href="/logout">
